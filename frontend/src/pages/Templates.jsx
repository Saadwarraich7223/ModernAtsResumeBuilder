...
const Templates = () => {
  ...
  return (
    <div
      className={`min-h-screen relative overflow-x-hidden font-sans selection:bg-indigo-500/20 transition-colors duration-500 ${isDarkMode ? "dark bg-[#020617]" : "bg-white"}`}
    >
      ...
      <main className="max-w-[1200px] mx-auto px-6 pt-32 pb-20">
        ...
        >
          ...
          <p className="text-base lg:text-lg text-slate-600 dark:text-indigo-100/70 font-medium leading-relaxed">
            Surgical-grade resume templates crafted by career experts. Change
            your design anytime within the editor.
          </p>
        </motion.div>
              ...
              >
                <div className="relative aspect-[3/4.2] rounded-[2rem] overflow-hidden bg-white dark:bg-slate-900 shadow-lg border border-slate-100 dark:border-slate-800 group-hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                    <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      <p className="text-white text-xs font-medium mb-6 opacity-80 leading-relaxed">
                        {tpl.description}
                      </p>
                      <Button
                        variant="gradient"
                ...
                <div className="mt-6 flex justify-between items-center px-2">
                  <div className="text-left">
                    <h3 className="text-lg font-bold text-slate-900 dark:text-slate-50 mb-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                      {tpl.name}
                    </h3>
      ...
      <section className="py-20 px-6 max-w-[1200px] mx-auto">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-indigo-100/70 max-w-xl mx-auto mb-10 font-medium relative z-10 leading-relaxed">
            You can switch templates at any time within the editor. Experiment
            with different styles to see which fits your profile best.
          </p>
          <Button
            variant="gradient"
            className="rounded-xl h-12 px-10 shadow-lg shadow-indigo-500/20"
      ...
      <footer className="py-12 border-t border-slate-100 dark:border-slate-900 text-center">
        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em]">
          © 2026 ResumeBuilder. Built for the modern professional.
        </p>
      </footer>
    </div>
  );
